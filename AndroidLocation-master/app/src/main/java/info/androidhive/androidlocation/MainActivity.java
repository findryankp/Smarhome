...
//                myRef.setValue("0");
                ApiClient api = Server.builder().create(ApiClient.class);
                Call<String> login = api.nool();
                login.enqueue(new Callback<String>() {
                    @Override
                    public void onResponse(Call<String> call, Response<String> response) {
                        Log.d("hai",response.message());
                    }
...
//    @OnClick(R.id.btn_start_location_updates)
    ...
    @OnClick(R.id.back_to_qrcode)
    public void setBackToQRcode() {
        stopLocationUpdates();
        Intent intent = new Intent(MainActivity.this, QRCodeActivity.class);
        startActivity(intent);
    }

    //----stop pencarian location---//
